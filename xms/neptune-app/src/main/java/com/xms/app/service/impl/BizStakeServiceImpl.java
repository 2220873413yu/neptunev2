...
import com.xms.common.utils.XmsTokenPriceUtils;
...
public class BizStakeServiceImpl implements BizStakeService {
	...
	public ResultPista<String> oldHToAcpDepositCallback(OldHToAcpDepositCallbackBo req) {
		...
		String sign = SignUtil.getSign(map, false, false, oldMd5Key);
		...
		AcpHPriceSnapshot priceSnapshot = XmsTokenPriceUtils.getAcpHPriceSnapshot();
		//入金赠送比例
