...
public class JwtAuthenticationAppTokenFilter extends OncePerRequestFilter {
	 ...
	 * 用户在链上购买了节点回调事件
	 */
	private static final String URL_NOTIFY_NODE_PACKAGE_CALLBACK = "/api/notify/nodeIdentity";

	/**
	 * 质押订单回调
	 */
	private static final String URL_NOTIFY_STAKE_ORDER_CALLBACK = "/stakeOrder/callback";
	private static final String URL_NOTIFY_buyPointsCallback_CALLBACK = "/buyPointsCallback/callback";
