...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper, UserInfo> implements UserInfoService {
	...
	public UserInfoBo getUserInfo(Long userId) {
		...
		userInfoBo.setNodeLevel(userInfo.getNodeLevel()>userInfo.getMinNodeLevel()?userInfo.getNodeLevel():userInfo.getMinNodeLevel());
		userInfoBo.setInviteUserCode(userInfo.getInviteUserCode());
		userInfoBo.setInviteUserId(userInfo.getInviteUserId());
		userInfoBo.setIsValid(userInfo.getIsValid());
		userInfoBo.setLayerLevel(userInfo.getLayerLevel()>userInfo.getMinLayerLevel()?userInfo.getLayerLevel():userInfo.getMinLayerLevel());
