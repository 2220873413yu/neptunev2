...
public enum ResponseCode {
	...
	//新增
	CODE_1251(1251, "不能购买低于当前节点身份的节点", ""),
	CODE_1252(1252, "节点身份不存在", ""),
	CODE_1253(1253, "暂不支持复购", ""),
	CODE_1254(1254, "暂无进行中的质押轮次", ""),
	CODE_1255(1255, "少于最低购买限制", ""),
	CODE_1256(1256, "完成入金即可解锁邀请功能", ""),
	CODE_1257(1257, "上笔订单暂未完成", ""),

	//新增部分
	CODE_1258(1258, "旧系统H数量必须大于0", ""),
	CODE_1259(1259, "质押太火爆了,请稍后再试", ""),
	CODE_1260(1260, "质押活动未开启,请稍后再试", ""),
