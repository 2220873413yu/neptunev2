...
<!--        <el-table-column align="center" label="用户编码" prop="userCode"/>-->
        <el-table-column :sort-orders="['descending', 'ascending']" align="center" label="节点收益" prop="validNum1" sortable="custom" />
        <el-table-column label="静态" align="center" prop="validNum2" sortable="custom" :sort-orders="['descending', 'ascending']" />
        <el-table-column label="动态" align="center" prop="validNum3" sortable="custom" :sort-orders="['descending', 'ascending']"/>
        <el-table-column label="财富" align="center" prop="validNum4" sortable="custom" :sort-orders="['descending', 'ascending']" />
