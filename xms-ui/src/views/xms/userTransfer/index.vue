...
<!--      <el-form-item label="转账用户UID" prop="fromUserId" label-width="120px">
        <el-input
      ...
      <el-form-item label="接收用户UID" prop="toUserId" label-width="120px">
        <el-input
...
<!--      <el-form-item label="转账用户账号" prop="fromAccount" label-width="120px">
        <el-input
...
<!--      -->
<!--
      <el-form-item label="接收用户账号" prop="toAccount" label-width="120px">
        <el-input
...
<!--      <el-form-item label="转账额度" prop="changeBalance">
      ...
      <el-form-item label="转账币种" label-width="120px" prop="coinType">
        <el-select v-model="queryParams.coinType" clearable placeholder="请选择转账币种">
          <el-option
            v-for="dict in dict.type.t_user_transfer_coin_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
...
<!--      <el-table-column label="转账用户UID" align="center" prop="fromUserId" />-->
      <el-table-column align="center" label="转账用户编码" prop="fromUserCode" />
      <el-table-column align="center" label="转账用户账号" prop="fromAccount" />
<!--      <el-table-column label="接收用户UID" align="center" prop="toUserId" />-->
      <el-table-column align="center" label="接收用户编码" prop="toUserCode" />
      <el-table-column align="center" label="接收用户账号" prop="toAccount" />
      <el-table-column align="center" label="转账订单号" prop="code" />

      <el-table-column align="center" label="转账币种" prop="coinType">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.t_user_transfer_coin_type" :value="scope.row.coinType"/>
        </template>
      </el-table-column>
...
export default {
  name: "UserTransfer",
  dicts: ['t_user_transfer_coin_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
