...
<!--      <el-form-item label="个人等级" prop="gameLevel" label-width="120px">
        <el-select v-model="queryParams.gameLevel" placeholder="请选择" clearable>
          <el-option
...
<!--      <el-form-item label="虚拟等级" prop="minGameLevel" label-width="120px">
        <el-select v-model="queryParams.minGameLevel" placeholder="请选择" clearable>
          <el-option
            v-for="dict in dict.type.t_user_info_game_level"
            :key="dict.value"
            :label="dict.label"
...
<!--      <el-table-column label="提现状态" align="center" prop="withdrawalOpenOrClose">
        <template slot-scope="scope">
...
<!--        <el-form-item label="用户编码" prop="userCode">
        ...
        <el-form-item label="节点等级" prop="nodeLevel">
          <el-select v-model="form.nodeLevel" placeholder="请选择">
            <el-option
              v-for="dict in dict.type.t_node_plan_node_level"
              :key="dict.value"
              :disabled="true"
        ...
        <el-form-item label="虚拟节点" prop="minNodeLevel">
          <el-select v-model="form.minNodeLevel" placeholder="请选择">
            <el-option
              v-for="dict in dict.type.t_node_plan_node_level"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="层级等级" prop="layerLevel">
          <el-select v-model="form.layerLevel" placeholder="请选择">
            <el-option
              v-for="dict in dict.type.t_user_invest_layer_config_level"
              :key="dict.value"
              :disabled="true"
        ...
        <el-form-item label="虚拟层级" prop="minLayerLevel">
          <el-select v-model="form.minLayerLevel" placeholder="请选择">
            <el-option
              v-for="dict in dict.type.t_user_invest_layer_config_level"
              :key="dict.value"
              :label="dict.label"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        minNodeLevel: [
          { required: true, message: "虚拟节点等级不能为空", trigger: "change" }
        ],
        minLayerLevel: [
          { required: true, message: "虚拟层级等级不能为空", trigger: "change" }
        ],
        email: [
