...
<script>
import { listUserinfo, getUserinfo, delUserinfo, addUserinfo, updateUserinfo,childListUserinfo } from "@/api/xms/userinfo";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      childListUserinfo(this.queryParams).then(response => {
    ...
    handleExport() {
      this.queryParams.params["topUserId"] = this.topUserId;
      this.download('xms/userinfo/childUserExport', {
        ...this.queryParams
