<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
      ...
      <el-form-item label="轮次ID" label-width="100px" prop="stakeRoundId">
        <el-input
      ...
      <el-form-item label="用户编码" label-width="100px" prop="userCode">
        <el-input
...
<!--    <el-row class="wallet-balance-container mb8">
    ...
    <el-table v-loading="loading" :data="withdrawalList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="轮次ID" prop="stakeRoundId"/>
...
<!--      <el-table-column label="链" align="center" prop="chainId">
      ...
      <el-table-column align="center" label="到账金额">
        <template slot-scope="scope">
          {{ Number(scope.row.changeBalance) - Number(scope.row.feeBalance) }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="财富仓比例" prop="wealthVaultRatio" >
        <template slot-scope="scope">
    ...
    <el-table-column align="center" label="保险仓比例" prop="insuranceVaultRatio" >
        <template slot-scope="scope">
