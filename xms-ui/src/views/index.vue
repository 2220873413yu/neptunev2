<template>
  <div class="dashboard-editor-container">
    <div class="--mb--rich-text"  >欢迎登录海王计划管理后台</div>
...
<!--    <el-row style="background:#fff;padding:16px 16px 0;margin-bottom:32px;">
    ...
    <el-row :gutter="32" class="chart-grid">
      <el-col :xs="24" :sm="24" :lg="24">
        <div class="chart-wrapper">
          <bar-chart :chart-data="lineStakeChartData" title="近7天质押量数据"/>
        </div>
      </el-col>
    </el-row>
  ...
  methods: {
    getList() {
      listGroupTotal().then(response =>{
        ...
        this.lineStakeChartData=response.data.lineStakeChartData
        console.log("lineWdwChartData",this.lineWdwChartData)
        console.log("lineStakeChartData",this.lineStakeChartData)
